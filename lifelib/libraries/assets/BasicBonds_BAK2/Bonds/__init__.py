...
def riskfree_curve():
    ...
    spot_date_ = [date_(0)] + list(date_(0) + ql.Period(dur) for dur in zero_curve.index)
...
bond_data = ("DataSpec", 1509134770960, 1509125691328)

ql = ("Module", "QuantLib")

zero_curve = ("DataSpec", 1509074183264, 1509126385184)