"""The main Space in the :mod:`~basiclife.model_BasicTerm_M` model.

:mod:`~basiclife.model_BasicTerm_M.Projection` is the only Space defined
in the :mod:`~basiclife.model_BasicTerm_M` model, and it contains
...
:mod:`~basiclife.model_BasicTerm_M.Projection` Space.)
...
Attributes:
    ...
    model_point_table: All model point data as a DataFrame.
        ...
        *generate_model_points.ipynb* included in the library.
        ...
        and ``sum_assured``.
        Cells defined in :mod:`~basiclife.model_BasicTerm_M.Projection`
