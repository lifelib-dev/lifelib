...
def build():
    ...
    override.import_module(
        module="override.mortality", name="Mortality", bases=[projbase, pvmixin]
    )

    override.import_module(
        module="override.lapse", name="Lapse", bases=[projbase, pvmixin]
    )

    override.import_module(
        module="override.lapse_mass", name="LapseMass", bases=[projbase, pvmixin]
    )

    override.import_module(
        module="override.expense", name="Expense", bases=[projbase, pvmixin]
    )
