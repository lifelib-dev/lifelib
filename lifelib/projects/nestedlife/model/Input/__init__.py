...
Scenarios = ("Pickle", 2325085267784)

DiscountRate = ("Pickle", 2325085434952)

PremWaiverCost = ("Pickle", 2325085434888)

Assumption = ("Pickle", 2325085914312)

ProductSpec = ("Pickle", 2325085915080)