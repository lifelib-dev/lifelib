...
* ``pol`` &rarr; {mod}`~annuallife.TradLife_A.PolicyAttrs`
* ``asmp`` &rarr; {mod}`~annuallife.TradLife_A.Assumptions`
* ``scen`` &rarr; {mod}`~annuallife.TradLife_A.Economic`
* ``comm_table`` &rarr; {mod}`~annuallife.TradLife_A.CommTable`
...
| Reference / Cell                                                                        | Excel named range  | Purpose                                |
| --------------------------------------------------------------------------------------- | ------------------ | -------------------------------------- |
